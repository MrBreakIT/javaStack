...
<body style="background-color: lightgray">
    <div class="container mt-5">
        <div class="jumbotron rounded ">
            <h1 class="text-center">Welcome to Game Genre Reviews</h1>
        </div>
        <c:if test="${user != null}">
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form action="/register" method="post" modelAttribute="registeringUser">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form action="/login" method="post" modelAttribute="loginUser">
                            ...
                            <div class="form-group">
                                <form:input path="email" class="form-control" placeholder="Email"
                                    value="john@email.com" /> <!-- NeatTrick but TAKE VALUE OUT -->
                                <form:errors path="email" class="text-danger" />
                            </div>
                            <div class="form-group">
                                <form:input type="password" path="password" class="form-control" placeholder="Password"
                                    value="123456" /> <!-- Neat trick butTAKE VALUE OUT -->
                                <form:errors path="password" class="text-danger" />
                            </div>

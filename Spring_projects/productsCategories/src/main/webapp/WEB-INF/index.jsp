...
<body style="background-color: #40798C">
	<div class="container col-10">
		...
		<div class="col-12 d-flex justify-content-around mt-3">
			<div class="left side d-flex justify-content-between m-2">
				<div class="col-sm-6 card form-group m-2"
					...
					<div class="card-body col-sm text-center">
						...
						<form:form action="/product" method="post"
							modelAttribute="newProduct" class="card-text">
					...
					<div class="col-sm  m-3">
						<div class="card-body col-sm text-center">
							...
							<form:form action="/category" method="post"
								modelAttribute="newCategory" class="card-text">
								<form:input path="name" placeholder="Product Category"
									class="form-control m-2" />
								<form:errors path="name" class="text-danger" />
			...
			<div class="row col">
				<div class="right-side mt-3 col-sm-12 m-3">
					<table class="table table-border table-light table-hover rounded">
						...
						<c:forEach items="${allProducts}" var="product">
							<tr>
								...
								<td>${product.price}</td>
								<td>${product.categoryDescription()}</td> <!-- use function to return String value -->
							</tr>
						</c:forEach>
					</table>
				</div>
				<div class="col-sm-6 m-3">
					<form action="/addCategoryToProduct" method="post">
						...
						<input type="submit" value="Add Category to Product"
									class=" col-8 btn btn-md btn-primary form-control" />
					</form>
				</div>
			</div>
		</div>

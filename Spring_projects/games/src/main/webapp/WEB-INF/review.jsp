...
<body style="background-image: url('minimalistGamePic.jpg')">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="card rounded">
					...
					<div class="card-body">
						<form:form action="/game/${someGame.id}/review" method="post"
							...
							<div class="row">
								...
								<div class="col-sm-8 form-group">
									<label>Review</label>
									<form:textarea path="content" var="content"
										class="form-control" />
									<form:errors path="content" class="text-danger" />
								</div>
							</div>
							<input type="submit"
								value="Upload a --${someGame.title}-- Review"

...
<body style="background-color: lightslategray">
	<div class="container">
		<h1>Edit ${singleSong.title} details</h1>
		<form:form action="/edit/update/${singleSong.id}" method="post"
			modelAttribute="singleSong">
			...
			<input type="submit" value="Save Edit" class="btn btn-sm btn-dark">
		</form:form>
